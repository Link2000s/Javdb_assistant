...
[![Version](https://img.shields.io/badge/version-0.9.0-blue.svg)](https://github.com/86168057/JavdbBuddy/releases)
...
2. 打开 [JavdbBuddy_v0.9.0.js](https://github.com/86168057/JavdbBuddy/raw/main/JavdbBuddy_v0.9.0.js)
...
### v0.9.0
- ✨ 新增：列表页「复制番号」快捷键
- ✨ 新增：草榴社区搜索（Google site 搜索）
- ✨ 新增：Emby / Jellyfin 状态标签独立开关
- ✨ 新增：服务器连接状态实时轮询检测（开关机自动感知）
- ✨ 新增：全面适配网站暗色模式（自动检测/跟随系统/手动切换）
- 🔧 优化：状态标签文字精简（"无法连接"、"未添加"）
- 🔧 优化：修复列表页状态标签与日期同行显示
- 🔧 优化：修复详情页搜索按钮重复创建
- 🔧 优化：修复开关切换时标签消失问题
