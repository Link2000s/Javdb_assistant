...
2. 打开 [JavdbBuddy_v1.0.0.js](https://github.com/86168057/JavdbBuddy/raw/main/JavdbBuddy_v1.0.0.js)
...
### v1.0.0
- ✨ 新增：字幕搜索下载功能（列表页/详情页一键搜索中文字幕，支持弹窗展示与直接下载）
- ✨ 新增：列表页「字幕」快捷键按钮
- ✨ 新增：详情页字幕匹配过滤与暗色模式适配
- 🔧 优化：列表页按钮布局自适应浏览器窗口大小
